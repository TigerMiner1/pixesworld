...
var botConfigs = {
    ...
    commands: [{"id":1,"command":"!cmds","message":"The Commands Are!","embed":true,"embedFields":[{"title":"!purge","text":"Purges The Number of Messages Sent!"},{"title":"!kick(@user)","text":"Kicks The User!"},{"title":"!report(@user)","text":"Reports The User!"},{"title":"!tempmuteuser(@user)","text":"Temp Mutes A User!"},{"title":"!serverinfo","text":"Shows The Server Info!"},{"title":"!weatherinfo (location)","text":"Shows The Weather Of The Location!"},{"title":"!play (music)","text":"Plays The Music Must Be In Voice Channel!"},{"title":"!shutdown","text":"Shuts The Server Down!(Only Owners)"}]}],
    ...
    welcomemessage: {"channelid":"541985319986135061","text":"Hello! Welcome To Our Server!"},
    weather: {"degree":"C"}
};
