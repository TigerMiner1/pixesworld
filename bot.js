    ...
    gameStatus: setInterval(() => {
      var acV = 1;
        if (acV == 1)
        {
            ...
            client.user.setActivity(`Pixes World!`, { type: 'WATCHING' })
            .catch(console.error);
            acV = 5;
        }
        else if (acV == 5) {
            client.user.setActivity(`Candy World!`, { type: 'STREAMING', url: "https://twitch.tv/gamerleb" })
            .catch(console.error);
            acV = 6;
        }
        else if (acV == 6) {
            client.user.setActivity(`Rob The Dockyard!`, { type: 'STREAMING', url: "https://twitch.tv/gamerleb" })
            .catch(console.error);
            acV = 7;
        }
        else if (acV == 7) {
            client.user.setActivity(`Case Clicker!`, { type: 'STREAMING', url: "https://twitch.tv/gamerleb" })
            .catch(console.error);
            acV = 8;
        }
        else {
